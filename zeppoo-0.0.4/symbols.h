/******************************************************************************/
/* symbols.h  -- see http://www.zeppoo.net                                    */
/*                                                                            */
...
void simpleViewSymbols(pTable *);
void writeSymbols(FILE *, char *);
void getSymbolsFingerprints(FILE *, pTable *);
void viewHijackSymbols(FILE *);
